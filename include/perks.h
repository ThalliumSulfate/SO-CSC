...
class Perks
{
    public:
        ...
        static Perk MischievousNature;
        static Perk AdaptableAppetite;
        static Perk FragileBody;
        //magin perks
        static Perk MysticalHorns;
        static Perk MindHorns;
        static Perk SoulHorns;
        static Perk CryoHorns;
        static Perk AquaHorns;
